  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-white/80 dark:bg-black/50",
        className,
      )}
    >
      {children}
